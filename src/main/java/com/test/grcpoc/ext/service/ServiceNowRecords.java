...
<<<<<<< HEAD
		    return snr.mapper(response, i , ii);
=======
		    snr.mapper();
...
//			fieldAl.add(f5);
		...
		return postE;
>>>>>>> f930563cf91c57d30885ccc26b9477035d0fa43c
	}
	
	public PostEntity mapper(ResponseEntity<ServiceNowResource> response, int i, int ii)
	{
		field f = new field();
		f.setName("ServiceNow Field Group:Snow Description");
		f.setValue(response.getBody().getResult().get(i).getInvoice_number());
